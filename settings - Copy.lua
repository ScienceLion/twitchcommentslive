...
local mod_id = "comment" -- This should match the name of your mod's folder.
...
{
	{
		...
		settings = {
			...
			},
			{
				...
				ui_description = "If On, display the damage you have taken (non physical chat only)",
				scope = MOD_SETTING_SCOPE_RUNTIME,
				value_default = false
			},
			{
				id = "pauseHM",
				ui_name = "Pause in Holy Mountain",
				ui_description = "If On, text will not appear while in Holy Mountain",
				value_default = false,
				scope = MOD_SETTING_SCOPE_RUNTIME
			},
			{
				id = "pauseBoss",
				ui_name = "Pause in Boss Area",
				ui_description = "If On, text will not appear while in Boss Area",
				value_default = false,
				scope = MOD_SETTING_SCOPE_RUNTIME
			},
			{
